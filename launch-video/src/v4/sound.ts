...
export const SFX: [string, number, number][] = [
  ...
  // 2 Resolve
  ["breath", 10, 0.5], ["whoosh-soft", 11.4, 0.6], ["click-1", 11.97, 0.55], ["whoosh-soft", 12.4, 0.45],
  ...r(13.4, 10, 0.05).map((t, i): [string, number, number] => [`tick-tuned-${i % 8}`, t, 0.35]),
  ["whoosh-soft", 14.05, 0.45], ["chime", 14.45, 0.8], ["paper-slide", 14.85, 0.3],
  // 3 All in one
