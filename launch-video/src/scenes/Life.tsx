...
type LifeCard = { art: IllustrationName; bg: string; kind: string; title: string; meta: string };

const CARDS: LifeCard[] = [
  { art: "habit-plant", bg: ground.sage, kind: "Habit", title: "Water the plants", meta: "Daily · 8:00" },
  { art: "goal-path", bg: ground.clay, kind: "Goal", title: "Take August off", meta: "Horizon · 2026" },
  { art: "focus-hourglass", bg: ground.stone, kind: "Focus", title: "Deep work, 90 min", meta: "Today · 9:00" },
  { art: "rituals-sun", bg: ground.sand, kind: "Ritual", title: "Morning review", meta: "Weekdays · 7:30" },
  { art: "calm-desk", bg: ground.mist, kind: "Week", title: "Plan next week", meta: "Friday · 16:00" },
  { art: "connected-puzzle", bg: ground.blush, kind: "Clients", title: "Acme kickoff", meta: "Mon · 10:00" },
];
      ...
      >
        {Array.from({ length: COLS * ROWS }, (_, i) => {
          ...
          return (
            ...
            >
              <div style={{ height: CH * 0.6, background: card.bg, display: "flex", alignItems: "center", justifyContent: "center" }}>
